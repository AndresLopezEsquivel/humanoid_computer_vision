...
distorted_images_folder = './distorted_images/*.jpg'

binary_images_folder = './binary_images_with_centroid/'

undistorted_images_folder = './undistorted_images_with_centroid/'

distorted_images_centroid_folder = './distorted_images_with_centroid/'

distorted_images_paths = glob.glob(distorted_images_folder)

for distorted_image_path in distorted_images_paths:

    img_name = distorted_image_path.split('/')[-1]
    ...
    bgr_image = cv2.circle(cv2.imread(distorted_image_path),
                           (distorted_centroid[0],
                            distorted_centroid[1]),
                            radius = 5,
                            color=(0, 0, 255),
    ...
    cv2.imwrite(f'{binary_images_folder}{img_name}',
                binary_image)

    cv2.imwrite(f'{distorted_images_centroid_folder}{img_name}',
                bgr_image)

    cv2.imwrite(f'{undistorted_images_folder}{img_name}',
                undistorted_img)    